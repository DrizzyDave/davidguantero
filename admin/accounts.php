                                        ...
                                        <div class="col-md-10">
                                            <div class="card">
                                                <div class="card-header">
                                                    <span class="font-weight-bold">ACCOUNTS</span>
                                                </div>
                                                <div class="card-body table-responsive">
                                                    <table class="table table-hover table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $councils = "SELECT * from council";

                                                            $accounts = mysqli_query($conn,$sog." UNION " .$teachers." UNION ".$councils);
                                                            while($account = mysqli_fetch_array($accounts)){
                                                                ?>
                                                                <tr>
                                                                    <td scope="row"><?php echo $account['id']?></td>
                                                                    ...
                                                                    <td>
                                                                        <div class="input-group-append">
                                                                            ...
                                                                            <div class="dropdown-menu">
                                                                                <a class="dropdown-item" href="session.php?id=<?php echo $account['id'] ?>&deleteAccount=">Delete</a>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
