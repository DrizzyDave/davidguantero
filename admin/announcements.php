                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="session.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" name="announce" class="btn btn-success btn-fill pull-right mx-2">Annouce</button>
                                                ...
                                                <td>
                                                    <div class="input-group-append">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="#Update" data-toggle="modal" data-target="#updateModal<?php echo $announcement['id']?>">Update</a>
                                                            <a class="dropdown-item" href="session.php?deleteAnnouncement=&id=<?php echo $announcement['id']?>">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <!-- Update -->
                                            <div class="modal fade" id="updateModal<?php echo $announcement['id']?>" tabindex="-1" role="dialog" aria-labelledby="updateModal<?php echo $announcement['id']?>" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="session.php?id=<?php echo $announcement['id']?>" method="POST">
