                                                ...
                                                <div class="card-body table-responsive">
                                                    <table class="table table-hover table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $schedule_list = mysqli_query($conn,"SELECT * from schedule_list");
                                                                    ...
                                                                    <td>
                                                                        <div class="input-group-append">
                                                                            ...
                                                                            <div class="dropdown-menu">
                                                                                <a class="dropdown-item" href="session.php?id=<?php echo $reservation['id']?>&Approve">Approve</a>
                                                                                <a class="dropdown-item" href="session.php?id=<?php echo $reservation['id']?>&Reject">Reject</a>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
